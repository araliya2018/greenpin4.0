    ...
    return(
      <View style={styles.container}>
        ...
        <View style={styles.profileContainer}>
          <Text style={styles.title}>Plantathon</Text>
          <Text style={{color:'green'}}> Plant and have fun </Text>
        </View>
        <View style={styles.buttonContainer}>
          <Text style={{color:'white', fontSize:18, fontWeight:'bold',marginLeft:55}}>USERNAME</Text>
          ...
          <Text style={{color:'white', fontSize:18, fontWeight:'bold',marginLeft:55}}>PASSWORD</Text>
          <View style={{alignItems:'center'}}>
            <TextInput
              style={styles.loginBox}
              secureTextEntry = {true}
